#!/usr/bin/env bash
# CEASER DerivO3CPU example using nolibc sender (legacy helper).
set -euo pipefail
...
CFG="$BASE_DIR/ceaser/perf_analysis/gem5/configs/example/spec06_config_multiprogram_o3_example.py"
OUTDIR="${OUTDIR:-./stats_ceaser_o3}"
...
MIRAGE_MODE=${MIRAGE_MODE:-ceaser}
...
echo "[*] Running CEASER O3 with sender: $SENDER_MODE"
