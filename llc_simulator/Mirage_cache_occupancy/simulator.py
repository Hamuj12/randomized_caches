...
class Simulator(object):
    ...
    def run_simulation(self, num_blocks_per_set, num_words_per_block, cache_size, num_partitions, replacement_policy, num_addr_bits, num_additional_tags, word_addrs, num_of_victim_access):
        ...
        refs_victim = self.get_addr_refs(victim_words, num_addr_bits, num_offset_bits, num_index_bits, num_tag_bits, num_partitions, num_tag_blocks_per_skew) 

        cache.read_refs(num_total_ways, num_partitions, replacement_policy, num_words_per_block, num_index_bits, refs_victim)
